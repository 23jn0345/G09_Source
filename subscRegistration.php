...
<body>
    ...
    <form method = "POST" action ="">
        ...
        <div class="category">
            <input type="radio" id="50001" name="category" value="50001" <?php if($returncategory == ""): ?>checked<?php elseif($returncategory == "50001") :?> checkd <?php endif ?>  />
        ...
        <br>
        <p>説明　　　　　<input type="text" class="detail" size="55px" name="detail" value ="<?php if($returndetail != ""): ?> <?=$returndetail ?><?php endif ?>" required></p>
        <p>公式サイトURL<input type="text" name = "url" size="55px" value ="<?php if($returnurl != ""): ?> <?=$returnurl ?><?php endif ?>" required></p>
        <br>
